...
namespace yancy
{
    ...
    {
        std::shared_ptr<char> host(new char[512], yancy::delete_array<char>);
    ...
    std::string _GetIPv4() 
    {
        std::shared_ptr<char> ipv4(new char[INET_ADDRSTRLEN], yancy::delete_array<char>);
