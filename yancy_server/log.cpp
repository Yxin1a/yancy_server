...
namespace yancy
{
    ...
    {
        yancy::LogFormatter::ptr new_val(new yancy::LogFormatter(val));
    ...
    yancy::ConfigVar<std::set<LogDefine> >::ptr g_log_defines=
        yancy::Config::Lookup("logs",std::set<LogDefine>(),"logs config");
