    ...
    return def;
        ...
        public:
            ...
            typedef std::map<std::string, std::string, CaseInsensitiveLess> MapType;    //MAP结构(key  请求协议的参数)
                                                                                        //       (Host: wwww.yancy.top)
                                                                                        //       key=Host  请求协议的参数=wwww.yancy.top
            ...
            const MapType& getHeaders() const { return m_headers;}  //返回HTTP请求的消息头MAP   (Host: wwww.yancy.top)
        ...
        private:
            ...
            */
            ...
            MapType m_headers;  //请求头部MAP   (Host: wwww.yancy.top)
        ...
        public:
            ...
            typedef std::map<std::string, std::string, CaseInsensitiveLess> MapType;    //MAP结构(key:  响应头部参数)
                                                                                        //       (Host: wwww.yancy.top)
                                                                                        //       key=Host  响应头部参数=wwww.yancy.top
                                                                                        //CaseInsensitiveLess忽略大小写比较是否相等仿函数
