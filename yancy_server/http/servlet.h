    ...
    namespace http
    {
        ...
        public:
            ...
            virtual int32_t handle(yancy::http::HttpRequest::ptr request
                        ...
                        , yancy::http::HttpSession::ptr session) = 0;
        ...
        public:
            ...
            typedef std::function<int32_t (yancy::http::HttpRequest::ptr request
                        , yancy::http::HttpResponse::ptr response
                        , yancy::http::HttpSession::ptr session)> callback; //函数回调类型定义  Servlet签名
