...
namespace yancy
{
    namespace http
    {
        ...
        std::ostream& HttpRequest::dump(std::ostream& os) const //序列化输出到流中
        {
            ...
            for(auto& i : m_headers)    //Host: wwww.yancy.top
            {
        ...
        //                     yancy::StringUtil::UrlDecode(str.substr(key + 1, pos - key - 1)))); \
        //         if(pos == std::string::npos) { \
        //             break; \
        //         } \
        //         ++pos; \
        ...
        //         return;
        //     }
        //     PARSE_PARAM(cookie, m_cookies, ';', yancy::StringUtil::Trim);
        //     m_parserParamFlag |= 0x4;
        // }
        ...
        //     if(expired > 0)
        //     {
        //         ss << ";expires=" << yancy::Time2Str(expired, "%a, %d %b %Y %H:%M:%S") << " GMT";
        //     }
        //     if(!domain.empty())
        //     {
        //         ss << ";domain=" << domain;
