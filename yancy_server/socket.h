...
namespace yancy
{
    ...
    public:
         ...
         *      address 地址
         */
        static Socket::ptr CreateTCP(yancy::Address::ptr address);

        /**
         *  创建UDP Socket(满足地址类型)
         *      address 地址
         */
        static Socket::ptr CreateUDP(yancy::Address::ptr address);
    ...
    //     static SSLSocket::ptr CreateTCP(yancy::Address::ptr address);
